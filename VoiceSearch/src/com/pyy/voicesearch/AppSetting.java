...
public class AppSetting extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listItemAdapter = new SimpleAdapter(AppSetting.this, listData,// 数据源
	...
	class SQLiteDatabaseDao {
		public SQLiteDatabaseDao() {
			...
			// 初始化创建表
			createTable(mDb, "application");
			// 初始化插入数据
			// insert(mDb, "application");
			// 初始化获取所有数据表数据
	...
	OnCreateContextMenuListener listviewLongPress = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,
			...
			new AlertDialog.Builder(AppSetting.this)
					// 弹出窗口的最上头文字
					.setTitle("Delete")
					// 设置弹出窗口的图式
					...
					.setPositiveButton("Delete",
							new DialogInterface.OnClickListener() {
								public void onClick(
									...
									if (dao.delete(mDb, "application", id)) {
										// 移除listData的数据
	...
	View.OnClickListener btnAddOnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			 ...
			 * 带编辑框Dialog样式
			 */
			LayoutInflater inflater = (LayoutInflater) AppSetting.this
					.getSystemService(LAYOUT_INFLATER_SERVICE);
			final View view = inflater.inflate(R.layout.appdialog, null);
			...
			final Builder dialog = new AlertDialog.Builder(AppSetting.this);
			/* 弹出窗口的最上头文字 */
			dialog.setTitle("Add New App")
					/* 设置弹出窗口的图式 */
					.setIcon(android.R.drawable.ic_dialog_info)
					/* 设置弹出窗口的信息 */
					.setView(view)
							...
							new DialogInterface.OnClickListener() {
								public void onClick(
									...
									if (username.matches("")
										...
										// 获取数组具体值后,可以对数据进行相关的操作,例如更新数据
										if (dao.check(mDb, "application",
												username)) {
											// 添加listData的数据
											if (dao.insert(mDb, "application",
													username, userpass)) {
